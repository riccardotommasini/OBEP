...
import sr.obep.impl.content.MergeContentExpression;
...
import sr.obep.impl.pipeline.CEP;
import sr.obep.impl.programming.ProgramManagerImpl;
...
//            cep.register_event_schema(out_schema);
            ...
            q.getLogicalEvents().forEach(logicalEvent -> {
                        ...
                        String new_event = "create schema " + head + " as (event_content sr.obep.parser.events.Content)";
